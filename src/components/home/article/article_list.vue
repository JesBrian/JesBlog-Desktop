    ...
    <ul id="articleListComponent" style="width:100%; color:#999;">
        <li v-for="item in articleList">
            <div class="articleList" style="display:inline-block;">
                ...
                <router-link class="article-list-title text-effect text-hidden" to="/article">这是文章标题文章标题 The Article Title 文章标题 The Article Title 文章标题 The Article Title</router-link>
...
<script>
    import articleOper from '../base/extends/article_oper.vue';//文章列表操作栏组件
    import articleCategory from '../base/extends/article_category.vue';//文章列表分类组件
...
<style scoped>
    ...
    .article-list-title {
        max-width:62%; display:inline-block; text-indent:1.5em; font-size:17px; font-weight:700; line-height:1.3em; color:#BBB;
    }
