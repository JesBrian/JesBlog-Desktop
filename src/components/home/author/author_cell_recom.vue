...
<script>
    import avatar from "./avatar.vue";//头像组件
    import username from "./username.vue";//用户名组件
    import follow from "../base/button/follow.vue";//关注组件
    import leave from "../base/button/leave.vue";//"取消关注"按钮组件
