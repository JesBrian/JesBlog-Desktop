                    ...
                    <table style="width:100%; margin:28px 0 48px;">
                        ...
                        <tr>
                            <td style="width:18%; height:68px; text-align:center;">
                                <label for="newArticleTitle" class="MyIF add-data" style="font-size:20px; font-weight:700;">
                                    标题<i style="color:lightcoral">*</i>
                                </label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td style="height:68px; text-align:center;">
                                <label for="newArticleCategory" class="MyIF theme" style="font-size:20px; font-weight:700;">
                                    分类<i style="color:lightcoral">*</i>
                                </label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td style="height:68px; text-align:center;">
                                <label for="newArticleTag" class="MyIF kinds" style="font-size:20px; font-weight:700;">
                                    标签
                                </label>
                            </td>
                            <td>
                        ...
                        <tr style="width:100%; height:128px; line-height:128px;">
                            <td style="text-align:center;">
                                <label for="newArticleSummary" class="MyIF kinds" style="font-size:20px; font-weight:700;">
                                    简介
                                </label>
                            </td>
...
<script>
    ...
    export default {
        ...
        methods: {
             ...
             */
            uploadThumbnail() {
                let uploadThumbnailDom = document.getElementById('uploadThumbnail'), thisObj = this;
                ...
                uploadThumbnailDom.onchange = function (event) {
                    ...
                    data.append('userid', thisObj.$store.state.userInfo.id); // 添加form表单中其他数据 - 用户id
