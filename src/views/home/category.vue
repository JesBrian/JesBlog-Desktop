                        ...
                        <div style="height:68px; margin-top:18px;">
                            ...
                            <div style="margin-top:8px; color:#C0FFB4; font-family:'Microsoft YaHei UI'">
                                <a style="padding:0 12px; float:left;" title="A级">
                                    <p style="text-align:center; font-size:15px; color:#AAA; line-height:1.5em;">A</p>
                                    火热程度
                                </a>
                                <a style="padding:0 12px; float:left;" title="123456">
                                    <p style="text-align:center; font-size:15px; color:#AAA; line-height:1.5em;">{{ categoryData.articles }}</p>
                                    收录文章
                                </a>
                                <a style="padding:0 12px; float:left;" title="68000">
                                    <p style="text-align:center; font-size:15px; color:#AAA; line-height:1.5em;">{{ categoryData.follows }}</p>
                                    关注人数
                                </a>
                            </div>
                        </div>
...
<script>
    ...
    import follow from "../../components/home/base/extends/follow.vue";//"关注/取消关注"组件
