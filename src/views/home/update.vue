                ...
                <div style="width:80%; height:100%; margin:0 auto; color:#AAA; position:relative;">
                    ...
                    <table style="width:100%; margin:28px 0 48px;">
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="updateMail" v-model="mail" class="s1c-Bg box-show" style="width:368px; padding:3px 8px; font-size:20px;" type="text"/>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td style="width:18%; height:68px; text-align:center;">
                                <label for="updateHome" class="MyIF home" style="font-size:20px; font-weight:700;">
                                    主页
                                </label>
                            </td>
                            <td>
...
<script>
    ...
    export default {
        ...
        methods: {
             ...
             */
            uploadAvatar() {
                let uploadAvatarDom = document.getElementById('uploadAvatar'), thisObj = this;
