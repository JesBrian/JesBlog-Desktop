                    ...
                    <div style="width:100%; color:#EDE;">
                        ...
                        <div style="height:68px; margin-top:18px;">
                            ...
                            <div id="changeArticleContent" style="margin-top:8px;">
                                <a :class="{active:contentType === 'publishList'}" @click="changeContent('publishList')"><i class="MyIF add-data"></i> 已发表文章</a>
                                <a :class="{active:contentType === 'draftList'}" @click="changeContent('draftList')"><i class="MyIF information"></i> 草稿箱文章</a>
                                <a :class="{active:contentType === 'recycleList'}" @click="changeContent('recycleList')"><i class="MyIF trash-1"></i> 回收站文章</a>
                            </div>
